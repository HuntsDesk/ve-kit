---
name: review-docs
description: Review the docs/ hub for broken links, staleness, duplicate coverage, index currency, and size bloat. Files every finding to the board (tasks for high/critical, a ledger comment for medium/low).
...
- Model ID references (should be Opus 5.5 / Fable 5.1 / Sonnet 5 / Haiku 4.5 — `claude-opus-5-5`, `claude-fable-5-1`; Opus is the agent default)
- Deprecated Claude Code commands
- Stripe API version mismatch (currently `2026-04-22.dahlia`)
...
- `docs/<subsystem>/ARCHITECTURE.md`
